...
| Paper | Venue | Year |
|-------|-------|------|
| HDLFORGE: A two-stage multi-agent framework for efficient verilog code generation | arXiv | 2026 |
| AutoVeriFix+: High-correctness RTL generation via trace-aware causal fix and verification | arXiv | 2026 |
| Dr. RTL: Autonomous Agentic RTL Optimization through Tool-Grounded Self-Improvement | arXiv | 2026 |
...
| HDLCoRe: A training-free framework for mitigating hallucinations in LLM-generated HDL code | arXiv | 2025 |
...
| LAUDE: LLM-assisted unit test generation and debugging of hardware designs | arXiv | 2026 |
...
| Spec2Assertion: Automatic pre-RTL assertion generation using large language models | arXiv | 2025 |
...
| ChatHLS: Towards systematic design automation and optimization for high-level synthesis | arXiv | 2025 |
...
| TOPCELL: Topology Optimization of Standard Cell via LLMs | arXiv | 2026 |
...
| EasySize: Elastic analog circuit sizing via LLM-guided heuristic search | arXiv | 2025 |
...
| LATENT: LLM-augmented trojan insertion and evaluation framework for analog circuits | arXiv | 2025 |
...
| MMCircuitEval: A comprehensive multimodal circuit-focused benchmark for evaluating LLMs | arXiv | 2025 |
