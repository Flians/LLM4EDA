...
|-------|-------------|-------|------|
| HDLFORGE: A two-stage multi-agent framework for efficient verilog code generation | University of Southern California | arXiv | 2026 |
| AutoVeriFix+: High-correctness RTL generation via trace-aware causal fix and verification | HKUST (Guangzhou) | arXiv | 2026 |
| Dr. RTL: Autonomous Agentic RTL Optimization through Tool-Grounded Self-Improvement | HKUST | arXiv | 2026 |
| ChipCraftBrain: Validation-First RTL Generation via Multi-Agent Orchestration | — | arXiv | 2026 |
| MGEMMV: A multimodal LLM framework for GEMM verilog generation from circuit diagrams | — | IEEE TCAS-I | 2026 |
...
| CodeV-R1: Reasoning-Enhanced Verilog Generation | CAS / USTC | arXiv | 2025 |
...
| Free and fair hardware: A pathway to copyright infringement-free verilog generation using LLMs | Texas A&M University | arXiv | 2025 |
...
| HDLCoRe: A training-free framework for mitigating hallucinations in LLM-generated HDL code | University of Southern California | arXiv | 2025 |
| Veritas: Deterministic verilog code synthesis from LLM-generated conjunctive specifications | — | arXiv | 2025 |
| OpenRTLSet: A fully open-source dataset for large language model-based verilog code generation | — | ICLAD | 2025 |
| A2HCoder: An LLM-driven coding agent for hierarchical algorithm-to-HDL translation | — | arXiv | 2025 |
| Data is all you need: Finetuning LLMs for Chip Design via an Automated design-data augmentation framework | — | DAC | 2024 |
| CodeV: Empowering LLMs for Verilog Generation through Multi-Level Summarization | ShanghaiTech University | arXiv | 2024 |
...
| A Deep Learning Framework for Verilog Autocompletion Towards Design and Verification Automation | — | — | 2023 |

## Verification, Debugging & Testing

| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| CoverAssert: Iterative LLM Assertion Generation Driven by Functional Coverage | — | arXiv | 2026 |
| Assertain: Automated Security Assertion Generation Using Large Language Models | — | arXiv | 2026 |
| Fixbench-RTL: A comprehensive benchmark for evaluating LLMs on RTL debugging | — | — | 2026 |
| LAUDE: LLM-assisted unit test generation and debugging of hardware designs | University of Illinois Chicago | arXiv | 2026 |
| VeriRAG: A retrieval-augmented framework for automated RTL testability repair | — | arXiv | 2026 |
| VeriDebug: A Unified LLM for Verilog Debugging via Contrastive Embedding and Guided Correction | City University of Hong Kong | arXiv | 2025 |
...
| Spec2Assertion: Automatic pre-RTL assertion generation using large language models | Texas A&M University | arXiv | 2025 |
| LISA: LLM informed systemverilog assertion generation with RAG and chain-of-thought | — | ISVLSI | 2025 |
| AssertionForge: Enhancing formal verification assertion generation with structured reasoning | — | arXiv | 2025 |
| ConfiBench: Automatic Testbench Generation with Confidence-Based Scenario Mask and Testbench Ensemble using LLMs for HDL Design | Technical University of Munich | MLCAD | 2024 |
...
| Self-HWDebug: Automation of LLM Self-Instructing for Hardware Security Verification | — | — | 2024 |
...
| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| Bench4HLS: End-to-end evaluation of LLMs in high-level synthesis code generation | — | arXiv | 2026 |
| Hierarchical mixture of experts: Generalizable learning for high-level synthesis | Peking University | AAAI | 2025 |
| LIFT: LLM-based pragma insertion for HLS via GNN supervised fine-tuning | — | arXiv | 2025 |
| ChatHLS: Towards systematic design automation and optimization for high-level synthesis | Southeast University | arXiv | 2025 |
...
| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| MappingEvolve: LLM-driven code evolution for technology mapping | — | DAC | 2026 |
| Autonomous Evolution of EDA Tools: Multi-Agent Self-Evolved ABC | — | arXiv | 2026 |
| GenEDA: Unleashing Generative Reasoning on Netlist via Multimodal Encoder-Decoder Aligned Foundation Model | — | arXiv | 2025 |
| LLSM: LLM-enhanced logic synthesis model with EDA-guided CoT prompting | — | ASPDAC | 2025 |
| LLM4Netlist: LLM-enabled step-based netlist generation from natural language | — | IEEE JETCAS | 2025 |

## Physical Design

| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| ModuPlace: LLM-assisted modular PCB placement via preference-optimized constraint graph generation | — | DAC | 2026 |
| Expert-level Leaf Cell Layout Generation via Preference-Optimized LLM | — | ICML | 2026 |
| TOPCELL: Topology Optimization of Standard Cell via LLMs | University of Maryland | arXiv | 2026 |
| Standard Cell Layout Generation: Methodological Evolution and Architectural Exploration with LLMs | — | ASPDAC | 2026 |
...
| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| AutoSizer: Automatic sizing of analog and mixed-signal circuits via large language models | — | arXiv | 2026 |
| LaMAGIC: Advanced circuit formulations for language-model-based topology generation | — | TODAES | 2026 |
...
| EasySize: Elastic analog circuit sizing via LLM-guided heuristic search | Shanghai Jiao Tong University | arXiv | 2025 |
| Towards Generative AI for Analog and RF IC Design: From Specification to GDSII | — | ICCAD | 2025 |
...
| AMSnet-KG: A Netlist Dataset for LLM-based AMS Circuit Auto-Design Using Knowledge Graph RAG | Eastern Institute of Technology, Ningbo | arXiv | 2024 |
...
| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| Retrieve, schedule, reflect: LLM agents for chip QoR optimization | — | arXiv | 2026 |
| Exploring the agentic frontier of verilog code generation | — | arXiv | 2026 |
| LEGO: An LLM Skill-Based Front-End Design Generation Platform | — | arXiv | 2026 |
...
| Automated Multi-Agent Workflows for RTL Design | UT Austin | NeurPS | 2025 |
| JARVIS: A multi-agent code assistant for high-quality EDA script generation | — | arXiv | 2025 |
| AutoEDA: Enabling EDA Flow Automation through Microservice-Based LLM Agents | Duke University | arXiv | 2025 |
...
| ChatLS: Multimodal retrieval-augmented generation and chain-of-thought for logic synthesis | — | DAC | 2025 |
| RapidGPT: Your Ultimate HDL Pair-Designer | — | — | 2024 |
| ChatEDA: A Large Language Model Powered Autonomous Agent for EDA | — | TCAD | 2024 |
| New Interaction Paradigm for Complex EDA Software Leveraging GPT | — | arXiv | 2023 |
...
| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| TrojanGYM: A detector-in-the-loop LLM for adaptive RTL hardware trojan insertion | — | arXiv | 2026 |
| NETLAM: An Automated LLM Framework to Generate and Evaluate Stealthy Hardware Trojans | — | arXiv | 2025 |
| RTLMarker: Protecting LLM-Generated RTL Copyright via a Hardware Watermarking Framework | Institute of Computing Technology, CAS | ASPDAC | 2025 |
...
| TrojanLoC: LLM-based framework for RTL trojan localization | — | arXiv | 2025 |
| LATENT: LLM-augmented trojan insertion and evaluation framework for analog circuits | Arizona State University | arXiv | 2025 |
| LLMs for Hardware Security: Boon or Bane? | — | arXiv | 2024 |
| DIVAS: An LLM-based End-to-End Framework for SoC Security Analysis and Policy-based Protection | — | — | 2024 |
| LLM for SoC Security: A Paradigm Shift | — | — | 2024 |
| Generating Secure Hardware using ChatGPT Resistant to CWEs | — | — | 2023 |
| Unlocking Hardware Security Assurance: The Potential of LLMs | — | — | 2023 |
| Fixing Hardware Security Bugs with Large Language Models | — | — | 2023 |
...
| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| AutoFlows++: Hierarchical Message Flow Mining for System on Chip Designs | — | arXiv | 2026 |
| ChipMind: LLMs for Agile Chip Design | — | VTS | 2025 |
| TPU-Gen: LLM-Driven Custom Tensor Processing Unit Generator | New Jersey Institute of Technology | arXiv | 2025 |
| Autocomp: LLM-driven code optimization for tensor accelerators | — | arXiv | 2025 |
| QiMeng: Fully Automated Hardware and Software Design for Processor Chip | CAS Intelligent Software Research Center | arXiv | 2025 |
...
| Paper | Affiliation | Venue | Year |
|-------|-------------|-------|------|
| ChipBench: A next-step benchmark for evaluating LLM performance in AI-aided chip design | — | arXiv | 2026 |
| A Survey of Research in Large Language Models for Electronic Design Automation | University of Florida | TODAES | 2025 |
...
| Survey and benchmarking of large language models for RTL code generation: The state of the art | — | arXiv | 2025 |
| SynCircuit: Automated generation of new synthetic RTL circuits can enable better LLMs | — | — | 2025 |
| Comprehensive verilog design problems: A next-generation benchmark dataset for LLMs | — | arXiv | 2025 |
| Lowering the bar: How large language models can be used as a copilot by hardware designers | — | — | 2025 |
...
| OpenLLM-RTL: Open Dataset and Benchmark for LLM-Aided Design RTL Generation | — | ICCAD | 2024 |
